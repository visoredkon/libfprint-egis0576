...
#define EGIS0576_DARK_PORTION_MIN 0.02
#define EGIS0576_DARK_PORTION_MAX 0.88
#define EGIS0576_MIN_ABS_DIFF 1.5
#define EGIS0576_MIN_PROCESSED_UNIQ 5
#define EGIS0576_DARK_THRESHOLD 128
#define EGIS0576_MIN_BG_UNIQ 10
#define EGIS0576_BG_FAIL_MAX 3
#define EGIS0576_MIN_BG_VARIANCE 1.0
#define EGIS0576_MAX_PIXEL_VAL 255

#define EGIS0576_IMG_MIN_SUM_AVG 10

#define EGIS0576_DELAY_SHORT_MS 50
#define EGIS0576_DELAY_MED_MS 100
#define EGIS0576_DELAY_POLL_MS 200
#define EGIS0576_DELAY_CAPTURE_MS 300
